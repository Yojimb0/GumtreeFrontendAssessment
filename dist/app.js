...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/Users/yojimbo/_Dev/GumtreeFrontendAssessment/node_modules/react-hot-loader/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/Users/yojimbo/_Dev/GumtreeFrontendAssessment/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var _Widget = __webpack_require__(157);

	var _Widget2 = _interopRequireDefault(_Widget);

	var content = __webpack_require__(159);

	_react2["default"].render(_react2["default"].createElement(_Widget2["default"], { title: content.title, slides: content.content }), document.body);

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/yojimbo/_Dev/GumtreeFrontendAssessment/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "app.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Slide = __webpack_require__(158);
	...
	exports["default"] = _react2["default"].createClass({
		...
		handleClickPrev: function handleClickPrev() {
			var slide = this.state.currentSlide == 0 ? 0 : --this.state.currentSlide;
			this.setState({ currentSlide: slide });
		},
		handleClickCollapse: function handleClickCollapse() {
			this.setState({ collapsed: !this.state.collapsed });
		},
		handleClickNext: function handleClickNext() {
			var slide = this.state.currentSlide == this.state.lastSlide ? this.state.lastSlide : ++this.state.currentSlide;
			this.setState({ currentSlide: slide });
		},
			...
			return _react2["default"].createElement(
				...
				_react2["default"].createElement(
					...
					_react2["default"].createElement(
						"h1",
						null,
						_react2["default"].createElement("img", { className: "icon_doc", src: "assets/doc.svg" }),
						" ",
						_react2["default"].createElement(
							"span",
							{ className: "icon_alignedlabel" },
							this.props.title
						)
					),
					_react2["default"].createElement(
						"button",
						{ className: "collapse", onClick: this.handleClickCollapse },
						_react2["default"].createElement("img", { className: "icon_collapse", src: "assets/collapse.svg" })
					)
				),
				_react2["default"].createElement(
					"section",
					...
					_react2["default"].createElement(
						...
						this.props.slides.map(function (slide) {
							return _react2["default"].createElement(_Slide2["default"], { title: slide.title,
					...
					_react2["default"].createElement(
						...
						_react2["default"].createElement(
							...
							this.state.currentSlide == 0 ? null : _react2["default"].createElement(
								"button",
								{ className: "prev", onClick: this.handleClickPrev },
								_react2["default"].createElement("img", { className: "icon_left", src: "assets/left.svg" }),
								" ",
								_react2["default"].createElement(
									"span",
									{ className: "icon_alignedlabel" },
						...
						_react2["default"].createElement(
							"span",
							{ className: "button_wrapper" },
							this.state.currentSlide == this.state.lastSlide ? null : _react2["default"].createElement(
								"button",
								{ className: "next", onClick: this.handleClickNext },
								_react2["default"].createElement(
									"span",
									{ className: "icon_alignedlabel" },
									this.props.slides[this.state.currentSlide + 1].title
								),
								" ",
								_react2["default"].createElement("img", { className: "icon_right", src: "assets/right.svg" })
							)
						)
					)
				)
...
/***/ function(module, exports, __webpack_require__) {
		...
		render: function render() {
			return _react2["default"].createElement(
				...
				this.props.thumbnail ? _react2["default"].createElement(
					"figure",
					null,
					_react2["default"].createElement("img", { src: 'assets/' + this.props.thumbnail, alt: this.props.title })
				) : null,
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/yojimbo/_Dev/GumtreeFrontendAssessment/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Slide.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
